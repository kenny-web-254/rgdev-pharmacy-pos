...
# Block actual browser-side authority/credential usage. Documentation/comments that merely
# mention the server-side secret variable name are not themselves an exposure.
forbidden = [
    ...
    (r"import\.meta\.env\.VITE_SUPABASE_SERVICE_ROLE", 'service-role Vite environment variable is exposed'),
    (r"process\.env\.SUPABASE_SERVICE_ROLE_KEY", 'service-role key is read by frontend source'),
]
